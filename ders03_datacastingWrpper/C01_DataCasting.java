...
public class C01_DataCasting {
    public static void main(String[] args) {
        ...
        long ln= sayi;  // esitligin sol tarfi long, sag tarafi yani deger int
                        // java itiraz etmedi.
        ...
        /*
        ama tersini yapmak istersek
        yani buyuk data turundeki bir degeri
        kucuk data turundeki variable'a atamak istersek java kabul etmez.
         */
